...
my_local_download_dir_warc = 'E:\warc_downloads'
# download dir for articles
my_local_download_dir_article = 'E:\scraped_sites\cc-news'
# hosts (if None or empty list, any host is OK)
domain_paths = [ii for ii in os.listdir('E:/Dropbox/peace-machine/peacemachine/data/domains') if ii.startswith('domains_')]
my_filter_valid_hosts = [] 
for dp in domain_paths:
    with open(f'E:/Dropbox/peace-machine/peacemachine/data/domains/{dp}', 'r') as f:
        my_filter_valid_hosts += f.read().splitlines()

# start date (if None, any date is OK as start date), as datetime
my_filter_start_date = datetime.datetime(2020,1,1)  # datetime.datetime(2016, 1, 1)
