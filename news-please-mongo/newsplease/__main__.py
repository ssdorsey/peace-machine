...
class NewsPleaseLauncher(object):
    ...
    def __init__(self, cfg_directory_path, is_resume, is_reset_elasticsearch, is_reset_json,
        ...
        self.mongo = self.cfg.section("MongoDB")
        ...
        # close the process
        if is_reset_elasticsearch or is_reset_json:
            sys.exit(0)
...
def cli(cfg_file_path, resume, reset_elasticsearch, reset_json, reset_all, no_confirm):
    ...
    NewsPleaseLauncher(cfg_file_path, resume, reset_elasticsearch, reset_json, no_confirm)
