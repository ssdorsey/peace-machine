...
def count_domain_loc(domain):
    ...
    dom_df.to_csv(f'D:Dropbox/ML for Peace/Counts_Civic/2020_11_20/{domain}.csv')
...
def count_domain_int(domain):
    ...
    dom_df.to_csv(f'D:Dropbox/ML for Peace/Counts_Civic/2020_11_20/{domain}_paraguay.csv')
