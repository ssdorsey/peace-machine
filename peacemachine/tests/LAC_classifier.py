...
if __name__ == "__main__":
    ...
    model = ClassificationModel(
            ...
            , args={'reprocess_input_data': True
                  ...
                  , 'eval_batch_size': 512
                  , 'num_train_epochs': 30
                  , 'output_dir': r'..\data\LAC\StackedModel'
                  , 'cache_dir': r'..\data\LAC\StackedModel'}) 

    model.train_model(train_stacked)
    ...
    model = ClassificationModel(
                ...
                , args={'reprocess_input_data': True
                    ...
                    , 'eval_batch_size': 512
                    , 'num_train_epochs': 30
                    , 'output_dir': r'..\data\LAC\CombinedModel'
                    , 'cache_dir': r'..\data\LAC\CombinedModel'}) 
        
    model.train_model(train_combined)