...
_internationals = ['reuters.com','bbc.com','nytimes.com','washingtonpost.com','aljazeera.com','theguardian','dw.com','france24.com','bloomberg.com','ft.com','wsj.com','csmonitor.com','latimes.com']
locals_re = '(extra\.ec|eluniverso\.com|elcomercio\.com|eltelegrafo\.com|lahora\.com\.ec|eldiario\.ec|expreso\.ec|metroecuador\.com\.ec|ultimasnoticias\.ec|diarioque\.ec|ppelverdadero\.com\.ec|elmercurio\.com\.ec|eltiempo\.com\.ec|laprensa\.com\.ec|lagaceta\.com\.ec|elnorte\.ec|noticias\.caracoltv\.com|bluradio\.com|noticias\.canalrcn\.com|lasillarota\.com|lasillavacia\.com|elespectador\.com|eltiempo\.com|portafolio\.co|semana\.com|canal1\.com\.co|elcolombiano\.com|elheraldo\.co|vanguardia\.com|elnuevosiglo\.com\.co|eluniversal\.com\.co|elpais\.com\.co|lafm\.com\.co|citytv\.com\.co|diarioadn\.co|pacifista\.tv|razonpublica\.com|verdadabierta\.com|caracol\.com\.co|pulzo\.com|cuestionpublica\.com|lacoladerata\.co|proclamadelcauca\.com|universocentro\.com|laorejaroja\.com|lanuevaprensa\.com\.co|baudoap\.com|sapienscol\.com|rutasdelconflicto\.com)'
internationals_re = '(reuters\.com|bbc\.com|nytimes\.com|washingtonpost\.com|aljazeera\.com|theguardian|dw\.com|france24\.com|bloomberg\.com|ft\.com|wsj\.com|csmonitor\.com|latimes\.com)'
...
if __name__ == "__main__":
    ...
    cursor = db.articles.find({'url': {'$regex': locals_re}}).sort([('_id', -1)])
    ...
    for _doc in tqdm(cursor):
        try:
            ...
            if not bool(db.lac.find_one({'url':_doc['url']})): # not already encoded
    ...
    cursor = db.articles.find({'url': {'$regex': internationals_re}}).sort([('_id', -1)])
